...
export function Typewriter({ delay, texts, baseText = "", className }: ITypewriterProps) {
...
function RepeatedTextAnimation({
  ...
  return <motion.span className="inline text-primary">{displayText}</motion.span>
}
...
function BlinkingCursor() {
  return (
    <motion.div
      ...
      animate="blinking"
      className="inline-block h-5 w-[1px] translate-y-1 bg-primary ml-1"
    />
  )
} 