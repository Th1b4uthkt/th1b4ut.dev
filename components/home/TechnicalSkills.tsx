...
const CommitGraph = dynamic(() => 
  import("@/components/ui/CommitGraph").then(mod => mod.CommitGraph), 
{
  ssr: false,
  loading: () => <div className="h-40 w-full flex items-center justify-center">Chargement du graphique...</div>
});
...
// Static content section to improve initial loading
  ...
  return (
    <section className="w-full py-10 md:py-16 lg:py-20 relative overflow-hidden">
      ...
      <div className="container px-4 md:px-6 mx-auto">
        ...
        {/* Commit Graph with lazy loading */}
        <motion.div
